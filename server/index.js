...
export default async (flo, recieved, next) => {
    ...
    const sections = [{
        ...
        title: 'Tooling',
        desc: '<b>WebQit Tooling</b> is how to bank more on native technologies and less on abstractions. <i>Explore new ways to do your magic with less engineering using conventional paradigms!</i>',
        highlights: [
            ...
            {icon: 'shuffle', content: '<b>Fullstack tools</b> - use the same code across all layers of your application stack.',},
